...
#define GRAPHICS_OPTIONS_HEIGHT 556
...
#define GRAPHICS_OPTIONS_CHECKBOX_FULLBRIGHT_TITLE "Full Brightness (ignore light effects)"
#define GRAPHICS_OPTIONS_CHECKBOX_FULLBRIGHT_X 18
#define GRAPHICS_OPTIONS_CHECKBOX_FULLBRIGHT_Y 395
#define GRAPHICS_OPTIONS_CHECKBOX_FULLBRIGHT_W 230
#define GRAPHICS_OPTIONS_CHECKBOX_FULLBRIGHT_H 22
#define GRAPHICS_OPTIONS_CHECKBOX_FULLBRIGHT_EVENTID 1014
#define GRAPHICS_OPTIONS_CHECKBOX_HIDEWASD_TITLE "Hide WASD toggle button"
#define GRAPHICS_OPTIONS_CHECKBOX_HIDEWASD_X 18
#define GRAPHICS_OPTIONS_CHECKBOX_HIDEWASD_Y 417
#define GRAPHICS_OPTIONS_CHECKBOX_HIDEWASD_W 230
#define GRAPHICS_OPTIONS_CHECKBOX_HIDEWASD_H 22
#define GRAPHICS_OPTIONS_CHECKBOX_HIDEWASD_EVENTID 1015
#define GRAPHICS_OPTIONS_CHECKBOX_HIDEPERCENT_TITLE "Hide HP/Mana percentages"
#define GRAPHICS_OPTIONS_CHECKBOX_HIDEPERCENT_X 18
#define GRAPHICS_OPTIONS_CHECKBOX_HIDEPERCENT_Y 439
#define GRAPHICS_OPTIONS_CHECKBOX_HIDEPERCENT_W 230
#define GRAPHICS_OPTIONS_CHECKBOX_HIDEPERCENT_H 22
#define GRAPHICS_OPTIONS_CHECKBOX_HIDEPERCENT_EVENTID 1016
	...
	switch(event)
	{
		...
		case GRAPHICS_OPTIONS_OK_EVENTID:
		{
			...
			if(pWindow && pWindow->getInternalID() == GUI_WINDOW_ADVANCEDGRAPHICSOPTIONS)
			{
				...
				GUI_CheckBox* pCB = SDL_static_cast(GUI_CheckBox*, pWindow->getChild(GRAPHICS_OPTIONS_CHECKBOX_FULLBRIGHT_EVENTID));
				if(pCB) g_engine.setFullBrightness(pCB->isChecked());
				pCB = SDL_static_cast(GUI_CheckBox*, pWindow->getChild(GRAPHICS_OPTIONS_CHECKBOX_HIDEWASD_EVENTID));
				if(pCB) g_engine.setHideWASD(pCB->isChecked());
				pCB = SDL_static_cast(GUI_CheckBox*, pWindow->getChild(GRAPHICS_OPTIONS_CHECKBOX_HIDEPERCENT_EVENTID));
				if(pCB) g_engine.setHideHPManaPercent(pCB->isChecked());
				g_engine.saveCFG();
				g_engine.removeWindow(pWindow);
			}
		}
...
void UTIL_advancedGraphicsOptions()
{
	...
	newListBox->startEvents();
	if(g_engine.getRealLightMode() == CLIENT_LIGHT_MODE_NEW)
		newListBox->setSelect(2);
	else if(g_engine.getRealLightMode() == CLIENT_LIGHT_MODE_OLD)
		newListBox->setSelect(1);
	else
		newListBox->setSelect(0);
	...
	newCheckBox->startEvents();
	newWindow->addChild(newCheckBox);
	newCheckBox = new GUI_CheckBox(iRect(GRAPHICS_OPTIONS_CHECKBOX_FULLBRIGHT_X, GRAPHICS_OPTIONS_CHECKBOX_FULLBRIGHT_Y, GRAPHICS_OPTIONS_CHECKBOX_FULLBRIGHT_W, GRAPHICS_OPTIONS_CHECKBOX_FULLBRIGHT_H), GRAPHICS_OPTIONS_CHECKBOX_FULLBRIGHT_TITLE, g_engine.getFullBrightness(), GRAPHICS_OPTIONS_CHECKBOX_FULLBRIGHT_EVENTID);
	newCheckBox->startEvents();
	newWindow->addChild(newCheckBox);
	newCheckBox = new GUI_CheckBox(iRect(GRAPHICS_OPTIONS_CHECKBOX_HIDEWASD_X, GRAPHICS_OPTIONS_CHECKBOX_HIDEWASD_Y, GRAPHICS_OPTIONS_CHECKBOX_HIDEWASD_W, GRAPHICS_OPTIONS_CHECKBOX_HIDEWASD_H), GRAPHICS_OPTIONS_CHECKBOX_HIDEWASD_TITLE, g_engine.getHideWASD(), GRAPHICS_OPTIONS_CHECKBOX_HIDEWASD_EVENTID);
	newCheckBox->startEvents();
	newWindow->addChild(newCheckBox);
	newCheckBox = new GUI_CheckBox(iRect(GRAPHICS_OPTIONS_CHECKBOX_HIDEPERCENT_X, GRAPHICS_OPTIONS_CHECKBOX_HIDEPERCENT_Y, GRAPHICS_OPTIONS_CHECKBOX_HIDEPERCENT_W, GRAPHICS_OPTIONS_CHECKBOX_HIDEPERCENT_H), GRAPHICS_OPTIONS_CHECKBOX_HIDEPERCENT_TITLE, g_engine.getHideHPManaPercent(), GRAPHICS_OPTIONS_CHECKBOX_HIDEPERCENT_EVENTID);
	newCheckBox->startEvents();
	newWindow->addChild(newCheckBox);
