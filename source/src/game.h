...
class Game
{
	public:
		...
		void sendLookAt(const Position& position, Uint16 itemId, Uint8 stackpos, bool debugLook = false);
		...
		void checkMovement(Direction dir, bool queueIfBusy = true);
	...
	protected:
		...
		Uint32 m_nextContainerOpenOrder = 1;
