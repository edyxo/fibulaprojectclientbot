...
class Creature : public Thing
{
	public:
		...
		void stopMove(bool checkNextMovement = true);
		...
		SDL_INLINE bool hasWalkSmoothing() {return (m_walkSmoothingStartTime != 0);}
		SDL_INLINE bool isWalkSmoothingAnimating() {return m_walkSmoothingAnimating;}
		SDL_INLINE Uint8 getCurrentFrame() {return m_currentFrame;}
		SDL_INLINE Uint8 getOutfitAnim() {return m_outfitAnim;}
		SDL_INLINE Sint32 getWalkedPixels() {return m_walkedPixels;}
	...
	protected:
		Sint32 getRawOffsetX(bool checkPreWalk = false);
		Sint32 getRawOffsetY(bool checkPreWalk = false);
		Sint32 getWalkSmoothingOffsetX();
		Sint32 getWalkSmoothingOffsetY();
		void startWalkSmoothing(Sint32 offsetX, Sint32 offsetY);
		void clearWalkSmoothing();
		...
		Uint32 m_walkTime = 0;
		Uint32 m_walkSmoothingStartTime = 0;
		Uint32 m_walkSmoothingDuration = 0;
		...
		Sint32 m_walkSmoothingOffsetX = 0;
		Sint32 m_walkSmoothingOffsetY = 0;
		...
		Direction m_walkSmoothingDirection = DIRECTION_SOUTH;
		...
		bool m_walkSmoothingAnimating = false;
