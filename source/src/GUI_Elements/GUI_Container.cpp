...
GUI_Element* GUI_Container::getElementAt(Sint32 x, Sint32 y)
{
	if(!m_visible || !m_tRect.isPointInside(x, y))
		return NULL;

	for(std::vector<GUI_Element*>::reverse_iterator it = m_drawns.rbegin(), end = m_drawns.rend(); it != end; ++it)
	{
