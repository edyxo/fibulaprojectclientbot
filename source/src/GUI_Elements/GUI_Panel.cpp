...
void GUI_Panel::render()
{
	...
	renderer->drawPictureRepeat(GUI_UI_IMAGE, GUI_UI_BACKGROUND_GREY_X, GUI_UI_BACKGROUND_GREY_Y, GUI_UI_BACKGROUND_GREY_W, GUI_UI_BACKGROUND_GREY_H, m_tRect.x1 + 2, m_tRect.y1 + 2, m_tRect.x2 - 4, m_tRect.y2 - 4);
