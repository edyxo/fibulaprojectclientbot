...
enum GUIWindowID
{
	...
	GUI_WINDOW_HOTKEYS,
	GUI_WINDOW_MANATRAINER,
	GUI_WINDOW_AUTOFISHER,
	GUI_WINDOW_AUTOLOGOUT,
	GUI_WINDOW_AUTORUNER,
	GUI_WINDOW_AUTOEATER,
	GUI_WINDOW_AUTOHEALER,
	GUI_WINDOW_COMBOLEADER,
	GUI_WINDOW_MAGICWALL,
	GUI_WINDOW_DONATE,
	GUI_WINDOW_ADMINTOOLS,
	GUI_WINDOW_MESSAGEBOX,
	GUI_WINDOW_BUGREPORT,
	GUI_WINDOW_MOTD,
...
class GUI_Window
{
	public:
		...
		GUI_Element* getElementAt(Sint32 x, Sint32 y);
